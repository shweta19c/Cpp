// careerPath.cpp : This file contains the 'main' function. Program execution begins and ends there.
//
...
int main()
{
	...
	{
		std::cout << "You are in " << grade << "th grade in the your selected stream.\n";
	}
	std::cout << "\n";
	...
	while (stream != 2)
	{
		...
		std::cout << "Enter your desired stream\n";
		std::cin >> stream;
		break;
	}
	if (stream == 2)
